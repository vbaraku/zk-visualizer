        ...
        <div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <ul className="list-disc list-inside space-y-2 text-blue-900">
              <li>The public output: <code className="bg-blue-100 px-2 py-1 rounded">out = 9</code></li>
        ...
        <div className="text-center">
          {verificationResult === null && !error && (
            <button
              ...
              className="bg-green-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-green-700 transition-colors disabled:bg-green-400 disabled:cursor-not-allowed text-lg"
            >
              {isVerifying ? (
          ...
          {verificationResult === false && (
            <div className="bg-red-50 border-2 border-red-300 p-6 rounded-lg">
              ...
              <p className="text-red-700">
                The proof is invalid. This shouldn't happen in our example!
              </p>
            </div>
          )}
