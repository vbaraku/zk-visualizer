      ...
      <header className="sticky top-0 z-50 w-full border-b border-solid border-b-[#e7edf3] bg-white/80 backdrop-blur-md px-6 lg:px-10 py-3 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-4 text-text-light-primary">
            ...
            <h2 className="text-lg font-bold leading-tight tracking-tight">ZK Visualizer</h2>
          </div>
          <nav className="hidden md:flex items-center gap-6">
            <a className="text-sm font-medium hover:text-primary transition-colors" href="#">Theory</a>
            <a className="text-sm font-medium text-primary" href="#">Visualizer</a>
        ...
        <div className="flex items-center gap-4">
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-white text-sm font-bold shadow-sm hover:bg-primary/90 transition-all">
